...
- 每一个二进制位（bit）有0和1两种状态，因此八个二进制位就可以组合出256种状态，这被称为一个字节(byte) ![bits](http://upload-markdown-images.oss-cn-beijing.aliyuncs.com/bits.jpg)
...
![bits](http://upload-markdown-images.oss-cn-beijing.aliyuncs.com/ascii.jpg)
