...
![img](http://upload-markdown-images.oss-cn-beijing.aliyuncs.com/cache2.png)
...
![img](http://upload-markdown-images.oss-cn-beijing.aliyuncs.com/cache4.png)

## 3. 请求流程

### 3.1 第一次请求

![img](http://upload-markdown-images.oss-cn-beijing.aliyuncs.com/cache6.png)
