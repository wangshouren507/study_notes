...
![img](http://upload-markdown-images.oss-cn-beijing.aliyuncs.com/mongostart.png)
...
![mongostat](http://upload-markdown-images.oss-cn-beijing.aliyuncs.com/mongostat.jpg)
...
- 如果有多条name是zfpx2的数据只更新一条,如果想全部更新需要指定
...
- 超级用户角色 **root**
- [mongod.conf](http://zhufengpeixun.com/etc/mongod.conf) 配置文件
