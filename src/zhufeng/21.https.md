...
![img](http://upload-markdown-images.oss-cn-beijing.aliyuncs.com/https1.png)
...
![img](http://upload-markdown-images.oss-cn-beijing.aliyuncs.com/https_http.png)

## 3. SSL 协议

HTTPS 协议的主要功能基本都依赖于 TLS/SSL 协议，TLS/SSL 的功能实现主要依赖于三类基本算法：散列函数 、对称加密和非对称加密，其利用非对称加密实现身份认证和密钥协商，对称加密算法采用协商的密钥对数据加密，基于散列函数验证信息的完整性。

![img](http://upload-markdown-images.oss-cn-beijing.aliyuncs.com/tls_ssl.png)
...
![img](http://upload-markdown-images.oss-cn-beijing.aliyuncs.com/https2.png)
...
![img](http://upload-markdown-images.oss-cn-beijing.aliyuncs.com/https3.png)
...
![img](http://upload-markdown-images.oss-cn-beijing.aliyuncs.com/ssltlsprotocal.png)

## 3.6 HTTPS协议改进过程

### 3.6.1 针对窃听风险

黑客可以嗅探通信内容 ![img](http://upload-markdown-images.oss-cn-beijing.aliyuncs.com/ssltlsprotocal.png)
...
![img](http://upload-markdown-images.oss-cn-beijing.aliyuncs.com/https_ssl.svg)
...
![img](http://upload-markdown-images.oss-cn-beijing.aliyuncs.com/https_protocal.png)

## 3.7 证书

证书的作用就是,我和服务端通信,我怎么知道这个服务端是我要真正通信的服务端呢

![img](http://upload-markdown-images.oss-cn-beijing.aliyuncs.com/zhengshu_brower.png)

### 3.7.1 申请和发放证书流程如下

![img](http://upload-markdown-images.oss-cn-beijing.aliyuncs.com/zhengshu.png)
...
![img](http://upload-markdown-images.oss-cn-beijing.aliyuncs.com/zhengshulian.png)
