...
![initrenderhtml](http://upload-markdown-images.oss-cn-beijing.aliyuncs.com/1.initrenderhtml.png)
...
![2.rendertext](http://upload-markdown-images.oss-cn-beijing.aliyuncs.com/2.rendertext.jpg)
...
![renderdom](http://upload-markdown-images.oss-cn-beijing.aliyuncs.com/3.renderdom.png)

### 4.2 类图

![20rendernativeunit](http://upload-markdown-images.oss-cn-beijing.aliyuncs.com/3.%2520rendernativeunit.jpg)

### 4.3 JSX语法

![compile](http://upload-markdown-images.oss-cn-beijing.aliyuncs.com/2.compile.png)
...
![customercomponent](http://upload-markdown-images.oss-cn-beijing.aliyuncs.com/5.customercomponent.png)

### 5.2 类图

![20rendercustomerunit](http://upload-markdown-images.oss-cn-beijing.aliyuncs.com/4.%2520rendercustomerunit.jpg)
...
![diffold](http://upload-markdown-images.oss-cn-beijing.aliyuncs.com/diffold.png)

![diffnew](http://upload-markdown-images.oss-cn-beijing.aliyuncs.com/diffnew.png)

![domdiff2](http://upload-markdown-images.oss-cn-beijing.aliyuncs.com/domdiff2.gif)
...
![sametree](http://upload-markdown-images.oss-cn-beijing.aliyuncs.com/sametree.png)

- 当出现节点跨层级移动时，并不会出现想象中的移动操作，而是以 A 为根节点的树被整个重新创建

![movemytree](http://upload-markdown-images.oss-cn-beijing.aliyuncs.com/movemytree.png)
...
![deleteall](http://upload-markdown-images.oss-cn-beijing.aliyuncs.com/deleteall.png)
...
![oldnewmove](http://upload-markdown-images.oss-cn-beijing.aliyuncs.com/oldnewmove.png)

![oldnewmove2](http://upload-markdown-images.oss-cn-beijing.aliyuncs.com/oldnewmove2.png)

![oldnewmove3](http://upload-markdown-images.oss-cn-beijing.aliyuncs.com/oldnewmove3.png)
