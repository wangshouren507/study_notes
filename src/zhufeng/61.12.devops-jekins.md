...
![cicd](http://upload-markdown-images.oss-cn-beijing.aliyuncs.com/cicd.jpg)

## 2. Jenkins

![cicdwithoutdocker](http://upload-markdown-images.oss-cn-beijing.aliyuncs.com/cicdwithoutdocker.png)

![dockercicd](http://upload-markdown-images.oss-cn-beijing.aliyuncs.com/dockercicd.png)
...
| Workspace Cleanup                  | ([https://plugins.jenkins.io/ws-cleanup),这个插件支持在构建前后](https://plugins.jenkins.io/ws-cleanup),%E8%BF%99%E4%B8%AA%E6%8F%92%E4%BB%B6%E6%94%AF%E6%8C%81%E5%9C%A8%E6%9E%84%E5%BB%BA%E5%89%8D%E5%90%8E) 删除或者部分删除workspace |
...
| Git                                | ([https://plugins.jenkins.io/git),支持使用Github、GitLab、Gerrit等系统管理代码仓库](https://plugins.jenkins.io/git),%E6%94%AF%E6%8C%81%E4%BD%BF%E7%94%A8Github%E3%80%81GitLab%E3%80%81Gerrit%E7%AD%89%E7%B3%BB%E7%BB%9F%E7%AE%A1%E7%90%86%E4%BB%A3%E7%A0%81%E4%BB%93%E5%BA%93) |
| Subversion                         | ([https://plugins.jenkins.io/subversion),支持Subversion系统管理源代码](https://plugins.jenkins.io/subversion),%E6%94%AF%E6%8C%81Subversion%E7%B3%BB%E7%BB%9F%E7%AE%A1%E7%90%86%E6%BA%90%E4%BB%A3%E7%A0%81) |
...
| LDAP                               | ([https://plugins.jenkins.io/ldap),这个插件允许使用LDAP对用户进行认证，LDAP](https://plugins.jenkins.io/ldap),%E8%BF%99%E4%B8%AA%E6%8F%92%E4%BB%B6%E5%85%81%E8%AE%B8%E4%BD%BF%E7%94%A8LDAP%E5%AF%B9%E7%94%A8%E6%88%B7%E8%BF%9B%E8%A1%8C%E8%AE%A4%E8%AF%81%EF%BC%8CLDAP) 服务器可以为Active Directory 或者 OpenLDAP |
...
![manageroles](http://upload-markdown-images.oss-cn-beijing.aliyuncs.com/manageroles.png)

![assignusers](http://upload-markdown-images.oss-cn-beijing.aliyuncs.com/assignusers.png)

![jprojects](http://upload-markdown-images.oss-cn-beijing.aliyuncs.com/jprojects.png)
...
![parameterbuild](http://upload-markdown-images.oss-cn-beijing.aliyuncs.com/parameterbuild.png)

![execshell](http://upload-markdown-images.oss-cn-beijing.aliyuncs.com/execshell.png)

![extendparameterbuild](http://upload-markdown-images.oss-cn-beijing.aliyuncs.com/extendparameterbuild.png)

![buildspec](http://upload-markdown-images.oss-cn-beijing.aliyuncs.com/buildspec.png)
...
![masterslave2](http://upload-markdown-images.oss-cn-beijing.aliyuncs.com/masterslave2.jpg)

![configureslave](http://upload-markdown-images.oss-cn-beijing.aliyuncs.com/configureslave.png)

![limitproject](http://upload-markdown-images.oss-cn-beijing.aliyuncs.com/limitproject.png)

![configslave2](http://upload-markdown-images.oss-cn-beijing.aliyuncs.com/configslave2.png)

## 8. 流水线

- Pipeline 插件

![mystageview](http://upload-markdown-images.oss-cn-beijing.aliyuncs.com/mystageview.png)

![pipelinegrammar](http://upload-markdown-images.oss-cn-beijing.aliyuncs.com/pipelinegrammar.png)
...
![scmscript](http://upload-markdown-images.oss-cn-beijing.aliyuncs.com/scmscript.png)
...
![constphp](http://upload-markdown-images.oss-cn-beijing.aliyuncs.com/constphp.png)

![phppipeline](http://upload-markdown-images.oss-cn-beijing.aliyuncs.com/phppipeline.png)
