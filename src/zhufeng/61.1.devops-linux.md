...
![bios](http://upload-markdown-images.oss-cn-beijing.aliyuncs.com/bios.jpg)
...
![PowerOnSelfTest](http://upload-markdown-images.oss-cn-beijing.aliyuncs.com/PowerOnSelfTest.jpg)
...
![BootSequence](http://upload-markdown-images.oss-cn-beijing.aliyuncs.com/BootSequence.jpg)
...
![mbr](http://upload-markdown-images.oss-cn-beijing.aliyuncs.com/mbr.png)
...
![mbr](http://upload-markdown-images.oss-cn-beijing.aliyuncs.com/mbr.jpg)
...
- 分区表的长度只有64个字节，里面又分成四项，每项16个字节。所以，一个硬盘最多只能分四个一级分区，又叫做
...
![mbrpartial](http://upload-markdown-images.oss-cn-beijing.aliyuncs.com/mbrpartial.jpg)
...
![diskfan](http://upload-markdown-images.oss-cn-beijing.aliyuncs.com/diskfan.jpg)
...
![idedisk](http://upload-markdown-images.oss-cn-beijing.aliyuncs.com/idedisk.jpg)

### 6.2 SCSI硬盘接口

![SCSIdisk](http://upload-markdown-images.oss-cn-beijing.aliyuncs.com/SCSIdisk.jpg)

### 6.3 SATA硬盘接口

![satadisk](http://upload-markdown-images.oss-cn-beijing.aliyuncs.com/satadisk.jpeg)

## 7. 分区

![diskformat2](http://upload-markdown-images.oss-cn-beijing.aliyuncs.com/diskformat2.jpg)
...
![fileallocate](http://upload-markdown-images.oss-cn-beijing.aliyuncs.com/fileallocate.png)
...
![mount](http://upload-markdown-images.oss-cn-beijing.aliyuncs.com/mount.jpg)
...
![桥接网络](http://upload-markdown-images.oss-cn-beijing.aliyuncs.com/bridage.jpg)
...
![主机网络](http://upload-markdown-images.oss-cn-beijing.aliyuncs.com/hostonly.gif)
...
![NAT](http://upload-markdown-images.oss-cn-beijing.aliyuncs.com/nat.jpg)
...
![networknat](http://upload-markdown-images.oss-cn-beijing.aliyuncs.com/bridageconnection.png)
...
![welcomeinstallcentos](http://upload-markdown-images.oss-cn-beijing.aliyuncs.com/welcomeinstallcentos.png)

### 11.3 跳过检查和警告

![skiptest](http://upload-markdown-images.oss-cn-beijing.aliyuncs.com/skiptest.png)

![skipwarning](http://upload-markdown-images.oss-cn-beijing.aliyuncs.com/skipwarning.png)

### 11.4 选择语言

![chooselanguage](http://upload-markdown-images.oss-cn-beijing.aliyuncs.com/1.selectchinese.png)

### 11.5 主机名

![choosehostname](http://upload-markdown-images.oss-cn-beijing.aliyuncs.com/choosehostname.png)

### 11.6 设置主机名和网络

![4.setuphostname.png](http://upload-markdown-images.oss-cn-beijing.aliyuncs.com/4.setuphostname.png)
...
![5.setuppassword.png](http://upload-markdown-images.oss-cn-beijing.aliyuncs.com/5.setuppassword.png)

### 11.8 使用存储空间

![6.layout.png](http://upload-markdown-images.oss-cn-beijing.aliyuncs.com/6.layout.png)

### 11.9 分区

![dividedisk](http://upload-markdown-images.oss-cn-beijing.aliyuncs.com/dividedisk.png)

![storewarning](http://upload-markdown-images.oss-cn-beijing.aliyuncs.com/storewarning.png)

![7.mbr.png](http://upload-markdown-images.oss-cn-beijing.aliyuncs.com/7.mbr.png)
...
![centostype](http://upload-markdown-images.oss-cn-beijing.aliyuncs.com/centostype.png)
...
![network1](http://upload-markdown-images.oss-cn-beijing.aliyuncs.com/network1.png)

![network2](http://upload-markdown-images.oss-cn-beijing.aliyuncs.com/network2.png)

![network3](http://upload-markdown-images.oss-cn-beijing.aliyuncs.com/network3.png)
