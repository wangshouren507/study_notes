...
- Generic Webhook Trigger web触发器
  ...
  - <http://admin:user@password:8080/generic-webhook-trigger/invoke>
...
![liblib](http://upload-markdown-images.oss-cn-beijing.aliyuncs.com/liblib.png)

![webhook](http://upload-markdown-images.oss-cn-beijing.aliyuncs.com/webhook.png)
...
![publishssh](http://upload-markdown-images.oss-cn-beijing.aliyuncs.com/publishssh.png)

![snedssh](http://upload-markdown-images.oss-cn-beijing.aliyuncs.com/snedssh.png)
