...
![er](http://upload-markdown-images.oss-cn-beijing.aliyuncs.com/er.png)
...
![er](http://upload-markdown-images.oss-cn-beijing.aliyuncs.com/onetoone.png)

#### 4.4.2 1对多（1:N）

1对多关系是指实体集A与实体集B中至少有N(N>0)个实体有关系；并且实体集B中每一个实体至多与实体集A中一个实体有关系。

![er](http://upload-markdown-images.oss-cn-beijing.aliyuncs.com/onetomany.png)

#### 4.4.3 多对多（M:N）

多对多关系是指实体集A中的每一个实体与实体集B中至少有M(M>0)个实体有关系，并且实体集B中的每一个实体与实体集A中的至少N（N>0）个实体有关系。

![er](http://upload-markdown-images.oss-cn-beijing.aliyuncs.com/manytomany.png)
...
![firstpattern](http://upload-markdown-images.oss-cn-beijing.aliyuncs.com/firstpattern.png)

#### 5.2.2 第二范式（2NF）

- 满足1NF后，要求表中的所有列，都必须依赖于主键，而不能有任何一列与主键没有关系，也就是说一个表只描述一件事情

![2th1](http://upload-markdown-images.oss-cn-beijing.aliyuncs.com/2th1.jpg)

![2th2](http://upload-markdown-images.oss-cn-beijing.aliyuncs.com/2th2.jpg)

![2th3](http://upload-markdown-images.oss-cn-beijing.aliyuncs.com/2th3.jpg)
...
![thirdpattern](http://upload-markdown-images.oss-cn-beijing.aliyuncs.com/thirdpattern.png)
...
![er](http://upload-markdown-images.oss-cn-beijing.aliyuncs.com/cms-er.png)
