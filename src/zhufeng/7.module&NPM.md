...
![lookmodule](http://upload-markdown-images.oss-cn-beijing.aliyuncs.com/lookmodule.png)

### 4.5 文件模块查找规则

![lookmodule](http://upload-markdown-images.oss-cn-beijing.aliyuncs.com/lookfile.png)
